...
class MoneyAgent(CellAgent):
    ...
    Each agent startes with 1 unit of wealth and 
    can give 1 unit to other agents if they occupy the same cell.
    ...
    def give_money(self):
        ...
        # Only give money if there are other agents present
        if cellmates: 
    ...
    def step(self):
        ...
        2. If wealth > 0, maybe give mony to another agent in the same cell
        """
        self.move()
        if self.wealth > 0:
            self.give_money()
